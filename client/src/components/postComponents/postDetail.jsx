...
function PostDetail() {
    ...
    function callApis() {
        fetch(`/api/post/find/${id}`, { credentials: "include" })
            .then(res => res.json())
            .then(data => {
                setPostData(data);
        ...
        fetch("/api/uploadform", { credentials: "include" })
    ...
    function handleLike() {
        ...
        fetch(`/api/post/find/${postData._id}/like`, {
            method: 'POST',
    ...
    function handleUnlike() {
        const id = currentUser._id
        fetch(`/api/post/find/${postData._id}/unlike`, {
            method: 'POST',
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ id: id }),
            credentials: "include"
